...
| `ec2-volume-size`                                                                                                                                                            | This will default to 30.                   | EC2 Volume Size for customization.                                                                                                                                                                                                                                                                                                    |
| `ec2-volume-mount-point`                                                                                                                                                     | This will default to `/dev/sda1`.          | EC2 Volume mount point for customization.                                                                                                                                                                                                                                                                                             |
...
| `max-reusable-instances`                                                                                                                                                     | Optional.                                  | Specify the maximum number of reusable (persistent) instances to allow. <br><br> If the number of running/stopped instances exceeds this value, new runners will be launched as standard non-resumable instances to prevent EBS volume leaks. Default is `2`. Set to `0` to disable this limit.                                       |
